      ...
      <section className="bg-neutral-900 text-white pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-stone-300 font-light max-w-3xl leading-relaxed border-l-2 border-terracotta-600 pl-6">
            Espaços de troca, aprendizado e qualificação. Nossas ações formativas buscam instrumentalizar artistas, produtores e gestores para os desafios contemporâneos da cena cultural.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-24 text-center border-t border-stone-200 pt-16">
            <h4 className="text-2xl font-serif font-bold text-neutral-900 mb-6">Gostaria de levar uma destas oficinas para sua cidade,evento, grupo ou coletivo?</h4>
            <a
