          ...
          <div className="mb-24">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white border-l-4 border-terracotta-600 shadow-sm p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start hover:shadow-lg transition-shadow duration-300">
                ...
                <img
                  src="/images/grupo-teatro-andante.png"
                  alt="Grupo Teatro Andante"
                  className="w-full md:w-1/3 h-48 object-contain bg-stone-100"
                />
              </div>
              ...
              <div className="bg-white border-l-4 border-terracotta-600 shadow-sm p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start hover:shadow-lg transition-shadow duration-300">
                ...
                {/* Optional Image Placeholder */}
                <img
                  src="/images/observatorio-festivais.jpg"
                  alt="Observatório dos Festivais"
                  className="w-full md:w-1/3 h-48 object-contain bg-stone-100"
                />
              </div>
            </div>
